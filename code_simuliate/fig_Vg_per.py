# -*- coding: utf-8 -*-
"""
Created on Mon Jul  1 15:09:37 2024
...
for i in [40,45,50,55,60]:    
    y1,y2,y3=ED.evogame(a1=0.5,a2=0.5,a3=0.5,vg_perh=i)
    lines=[y1,y2,y3]
    box.append(lines)
data6=np.array(box)
...
ax1.legend(['REG,Vg_perh=40','REG,Vg_perh=45','REG,Vg_perh=50','REG,Vg_perh=55','REG,Vg_perh=60'],fontsize=8)
...
ax2.legend(['HM,Vg_perh=40','HM,Vg_perh=45','HM,Vg_perh=50','HM,Vg_perh=55','HM,Vg_perh=60'],fontsize=8)
...
ax3.legend(['HU,Vg_perh=40','HU,Vg_perh=45','HU,Vg_perh=50','HU,Vg_perh=55','HU,Vg_perh=60'],fontsize=8)
...
ax4.plot(xs=box[0][0],ys=box[0][1],zs=box[0][2],color=c_string[0],linewidth=1.5,label='Vg_perh=40')
ax4.plot(xs=box[1][0],ys=box[1][1],zs=box[1][2],color=c_string[1],linewidth=1.5,label='Vg_perh=45')
ax4.plot(xs=box[2][0],ys=box[2][1],zs=box[2][2],color=c_string[2],linewidth=1.5,label='Vg_perh=50')
ax4.plot(xs=box[3][0],ys=box[3][1],zs=box[3][2],color=c_string[3],linewidth=1.5,label='Vg_perh=55')
ax4.plot(xs=box[4][0],ys=box[4][1],zs=box[4][2],color=c_string[4],linewidth=1.5,label='Vg_perh=60')

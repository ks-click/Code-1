# -*- coding: utf-8 -*-
"""
Created on Tue Jul  2 22:48:44 2024
...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul  1 11:38:25 2024
...
ax1.legend(['REG,Ph=24','REG,Ph=26','REG,Ph=28','REG,Ph=30','REG,Ph=32'],fontsize=8)
...
ax2.legend(['HM,Ph=24','HM,Ph=26','HM,Ph=28','HM,Ph=30','HM,Ph=32'],fontsize=8)
...
ax3.legend(['HU,Ph=24','HU,Ph=26','HU,Ph=28','HU,Ph=30','HU,Ph=32'],fontsize=8)
...
ax4.plot(xs=box[0][0],ys=box[0][1],zs=box[0][2],color=c_string[0],linewidth=1.5,label='Ph=24')
ax4.plot(xs=box[1][0],ys=box[1][1],zs=box[1][2],color=c_string[1],linewidth=1.5,label='Ph=26')
ax4.plot(xs=box[2][0],ys=box[2][1],zs=box[2][2],color=c_string[2],linewidth=1.5,label='Ph=28')
ax4.plot(xs=box[3][0],ys=box[3][1],zs=box[3][2],color=c_string[3],linewidth=1.5,label='Ph=30')
ax4.plot(xs=box[4][0],ys=box[4][1],zs=box[4][2],color=c_string[4],linewidth=1.5,label='Ph=32')

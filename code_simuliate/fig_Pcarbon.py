# -*- coding: utf-8 -*-
"""
Created on Sun Jun 30 10:48:43 2024
...
box=[]
for i in [0,0.067,0.096,0.125,0.154]:    
    y1,y2,y3=ED.evogame(a1=0.5,a2=0.5,a3=0.5,P_carbon=i)
    lines=[y1,y2,y3]
    box.append(lines)
data1=np.array(box)
...
ax1.legend(['REG,P_carbon=0','REG,P_carbon=0.067','REG,P_carbon=0.096','REG,P_carbon=0.125','REG,P_carbon=0.154'],fontsize=8)
...
ax2.legend(['HM,P_carbon=0','HM,P_carbon=0.067','HM,P_carbon=0.096','HM,P_carbon=0.125','HM,P_carbon=0.154'],fontsize=8)
...
ax3.legend(['HU,P_carbon=0','HU,P_carbon=0.067','HU,P_carbon=0.096','HU,P_carbon=0.125','HU,P_carbon=0.154'],fontsize=8)
...
ax4.plot(xs=box[0][0],ys=box[0][1],zs=box[0][2],color=c_string[0],linewidth=1.5,label='P_carbon=0')
ax4.plot(xs=box[1][0],ys=box[1][1],zs=box[1][2],color=c_string[1],linewidth=1.5,label='P_carbon=0.067')
ax4.plot(xs=box[2][0],ys=box[2][1],zs=box[2][2],color=c_string[2],linewidth=1.5,label='P_carbon=0.096')
ax4.plot(xs=box[3][0],ys=box[3][1],zs=box[3][2],color=c_string[3],linewidth=1.5,label='P_carbon=0.125')
ax4.plot(xs=box[4][0],ys=box[4][1],zs=box[4][2],color=c_string[4],linewidth=1.5,label='P_carbon=0.154')
